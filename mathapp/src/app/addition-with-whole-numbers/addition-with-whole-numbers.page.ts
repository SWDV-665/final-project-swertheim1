...
@Component({
    ...
    templateUrl: './addition-with-whole-numbers.page.html',
    styleUrls: ['./addition-with-whole-numbers.page.scss'],
})
export class AdditionWithWholeNumbersPage implements OnInit {
